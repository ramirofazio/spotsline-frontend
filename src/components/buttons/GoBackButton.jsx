...
export function GoBackButton({ className, textClassName, iconClassName, link }) {
  return (
    <NavLink to={link ?? -1} className={`icons flex items-center gap-2 hover:opacity-50 ${className}`}>
