...
export function Products() {
  ...
  return (
    <>
      <header className="relative hidden min-h-[400px] flex-col items-center justify-center gap-2 bg-signIn bg-cover bg-bottom pt-16 text-white shadow-medium before:absolute before:inset-0 before:z-10 before:bg-black/50  before:content-[''] sm:flex">
